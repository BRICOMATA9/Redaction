...
Figure \ref{fig:node}  presents one of the two Arduino boards equipped with an antenna that cover both 868 and \red{433} MHz band and with a SX1276 LoRa Transceiver.
