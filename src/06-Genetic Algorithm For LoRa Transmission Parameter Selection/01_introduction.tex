...
% Approach
In \refsec{Approach}, we propose our approach to solve LoRa parameter selection problem.
% Experimentation
Our experimentation in a real environment is presented in \refsec{Experimentation}.
% Results
